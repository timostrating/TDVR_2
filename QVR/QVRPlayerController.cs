...
public class QVRPlayerController : MonoBehaviour {
    ...
    public float JumpForce = 0.3f;                  // The force applied to the character when jumping.
    ...
    private float YRotation = 0.0f;                 // The player's current rotation about the Y axis.
    public bool HmdRotatesY = true;                 // If true, tracking data from a child OVRCameraRig will update the direction of movement.
    public float GravityModifier = 0.379f;          // Modifies the strength of gravity.
